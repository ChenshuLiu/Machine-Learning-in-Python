...
from helper import most_common_label

def entropy(y):
    # count number of occurrences of each class label
    hist = np.bincount(y)
    ps = hist / len(y)
...
class DecisionTree:
    ...
    def _grow_tree(self, X, y, depth = 0):
        ...
        if (depth >= self.max_depth 
            ...
            # if the conditions are satisfied, we are at the leaf node of the tree
